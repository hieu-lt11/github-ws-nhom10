...
<body>
    ...
    <div class="auth-page-wrapper pt-5">
        ...
        <div class="auth-one-bg-position auth-one-bg" id="auth-particles">
            ...
            <canvas class="particles-js-canvas-el" width="893" height="475" style="width: 100%; height: 100%;"></canvas>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Admin Đăng Nhập</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Đăng nhập để vào trang Admin Adadis.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form action="<?= BASE_URL_ADMIN . '?act=check-login-admin' ?>" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5 password-input" name="mat_khau" placeholder="Nhập mật khẩu" id="password-input">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">©
                                ...
                                </script> Adadis <i class="mdi mdi-heart text-danger"></i> by Team 5
                            </p>
                        </div>
                    </div>
                </div>
