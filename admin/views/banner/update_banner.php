...
<body>
                        ...
                        <div class="col">
                            ...
                            <div class="h-100">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <!-- <p class="text-muted">Use <code>form-floating</code> class to enable floating labels with Bootstrap’s textual form fields.</p> --><div class="live-preview">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="trang_thai" id="ForminputState" class="form-select" value="<?= $banNerw['trang_thai'] ?>">
                                                                ...
                                                                <option value="1" <?= $banNerw['trang_thai'] == 1 ? 'selected' : '' ?>>Đăng</option><option value="2" <?= $banNerw['trang_thai'] == 2 ? 'selected' : '' ?>>Không đăng</option>
                                                            </select>
    ...
    <!--start back-to-top--><button onclick="topFunction()" class="btn btn-danger btn-icon" id="back-to-top">
