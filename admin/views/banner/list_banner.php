...
<body>
                        ...
                        <div class="col">
                            ...
                            <div class="h-100">
                                <div class="card">
                                    ...
                                    <div class="card-body"><div class="live-preview">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="hstack gap-3 flex-wrap">
                                                                        <a href="?act=form-sua-banner&id_danh_muc_banner=<?= $banNer['id'] ?>" class="link-success fs-15"><i class="ri-edit-2-line"></i></a><form action="?act=xoa-banner" method="POST" enctype="multipart/form-data" onsubmit="return confirm('Bạn có đồng ý xóa không?')">
    ...
    <div class="customizer-setting d-none d-md-block">
        <div class="btn-info rounded-pill shadow-lg btn btn-icon btn-lg p-2" data-bs-toggle="offcanvas" data-bs-target="#theme-settings-offcanvas" aria-controls="theme-settings-offcanvas">
            <i class='mdi mdi-spin mdi-cog-outline fs-22'></i></div>
    </div>
